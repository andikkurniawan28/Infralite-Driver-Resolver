...
<head>
    ...
    <title>INFRALite-DriverResolver</title>
  <link rel="icon"
        type="image/png"
...
<body>
    ...
    <footer class="footer-white-gradient text-center py-3 mt-auto">
        <small>&copy; 2025 INFRALite-DriverResolver. All rights reserved.</small>
    </footer>
